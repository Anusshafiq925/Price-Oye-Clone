...
for (var brands in watches) {
  selectCompany.innerHTML += ` <option value="${brands}" >
            ${brands}
          </option>`;
}
...
function companySelection() {
  ...
  for (var product in watches[selectedCompany]) {
    selectProduct.innerHTML += ` <option value="${watches[selectedCompany][product].name}" >
            ${watches[selectedCompany][product].name}
          </option>`;
  }
}
